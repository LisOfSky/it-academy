...
//================================================= Exercise 5 =======================================================
// 5.1 (первоначальный вариант задания) Напишите функцию, которая вставит данные в массив в заданные несколько мест в массиве. 
...
function exFiveNew(someArray, newData) { 
    ...
    let newArray = [];
    console.log(someArray.length, newData.length)
